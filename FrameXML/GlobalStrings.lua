...
ARTIFACT_TUTORIAL_KNOWLEDGE = "Mouse over to view your Artifact Knowledge Level.";
...
BOOST2_WARLOCKAFF_FEAR = "Use |cFFFFFFFFFear|r frighten your target.";
...
CHATLOGENABLED = "Chat being logged to LogsWoWChatLog.txt";
...
CHAT_CHANNEL_LIST_GET = "|Hchannel:CHANNEL:%d|h[%s]|h32";
...
CHAT_RESTRICTED = "A Starter Edition account may only send whispers to players that have your character on their friends list. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
CHAT_RESTRICTED_TRIAL = "A Starter Edition account may only send whispers to players that have your character on their friends list. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
...
CHAT_TRIAL_RESTRICTED_NOTICE_TRIAL = "|Hchannel:%d|h[%s]|h Starter Edition accounts cannot send messages to this channel. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
...
COMBATLOGENABLED = "Combat being logged to LogsWoWCombatLog.txt";
...
ENCHANT_CONDITION_REQUIRES = "Requires32";
...
ERR_CHAT_RAID_RESTRICTED_TRIAL = "Starter Edition accounts cannot send messages to raid channel.  |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
ERR_CHAT_RAID_RESTRICTED_VETERAN = "Starter Edition accounts cannot send messages to raid channel. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
ERR_CHAT_RESTRICTED = "Starter Edition accounts cannot send unlimited tells. You must wait before you can send tells to more players.  |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
ERR_CHAT_RESTRICTED_TRIAL = "Starter Edition accounts cannot send unlimited tells. You must wait before you can send tells to more players.  |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
...
ERR_INVITE_RESTRICTED = "Starter Edition accounts cannot invite characters into groups. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
ERR_INVITE_RESTRICTED_TRIAL = "Starter Edition accounts cannot invite characters into groups. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
...
ERR_PETITION_RESTRICTED_ACCOUNT = "Starter Edition accounts may not sign guild charters. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
ERR_PETITION_RESTRICTED_ACCOUNT_TRIAL = "Starter Edition accounts may not sign guild charters. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
...
ERR_YELL_RESTRICTED = "Starter Edition accounts cannot yell. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
ERR_YELL_RESTRICTED_TRIAL = "Starter Edition accounts cannot yell. |cffffd000|HurlIndex:2|h[Click To Upgrade]|h|r";
...
FLASH_LOW_HEALTH_WARNING = "|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|tDo Not Flash Screen at Low Health";
...
IGNORE_QUEST = "Ignore";
IGNORE_QUEST_TUTORIAL = "You just ignored a quest!|n|nInteract with the quest giver again to view the quest, or select Hidden Quests from the tracker on your minimap.";
...
ITEM_RELIC_VIEWABLE = "<Right Click to view your equipped Artifact>";
...
ITEM_SET_BONUS_NO_VALID_SPEC = "Bonus effects vary based on player's specialization.";
...
LEVEL = "Level";
LEVEL_ABBR = "Lvl";
LEVEL_CAP_REACHED_TRIAL = "You have reached the maximum possible level on a Starter Edition account. |cffffd000|HurlIndex:2|h[Click Here]|h|r to upgrade your account!";
...
MONEY = "Money";
MONEY_CAP_REACHED_TRIAL = "You already have the maximum amount of money on a Starter Edition account. |cffffd000|HurlIndex:2|h[Click Here]|h|r to upgrade your account!";
MONEY_COLON = "Money:";
...
OPTION_TOOLTIP_CHAT_BUBBLES = "Shows player chat text in speech bubbles above their heads.";
...
PRIEST_SHADOW_CORE_ABILITY_6 = "Tranformation that enables Void Bolt and increases your damage by more the longer it is active";
PRIMARY = "Primary";
...
PVP_WEEKLY_BONUS_GAMES_WON = "Games Won: |cffffffff%d/%d|r";
...
SPELL_FAILED_CUSTOM_ERROR_329 = "You have already submitted the maximum number of Artifact Research work orders available.";
...
TEXT_MODE_A_STRING_RESULT_OVERENERGIZE = "(%d Overenergized)";
...
TOKEN_REDEEM_BALANCE_CONFIRMATION_DESCRIPTION = "Add %s to your Battle.net Balance?";
...
TRIAL_ACCOUNT_LEVEL_CAP_REACHED = "You have reached the maximum possible level on a Starter Edition account. |cffffd000|HurlIndex:2|h[Click Here]|h|r to upgrade your account!";
TRIAL_ACCOUNT_MONEY_CAP_REACHED = "You already have the maximum amount of money on a Starter Edition account. |cffffd000|HurlIndex:2|h[Click Here]|h|r to upgrade your account!";
...
TUTORIAL_TOKEN_GAME_TIME_STEP_2_BALANCE = "2. Redeem it for 30 days of game|ntime (or %s of Battle.net Balance).";
...
_G["7.0_NIGHTMARE_RAID_XAVIUS_NIGHTMARE_CORRUPTION"] = "Nightmare Corruption";
