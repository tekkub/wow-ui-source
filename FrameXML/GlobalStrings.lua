...
TOKEN_CURRENT_AUCTION_VALUE = "Current Auction Value: %s|n(subject to change)";
...
TUTORIAL_TOKEN_GAME_TIME_STEP_2_MINUTES = "2. Redeem it for 2700 minutes of game|n    time.";
